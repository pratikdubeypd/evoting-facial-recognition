...
urlpatterns = [
    ...
    path("polldetails/<int:poll_id>/editpublicpoll", views.editpublicpoll, name="editpublicpoll"),
    ...
    path("privatepolldetails/<int:poll_id>/editprivatepoll", views.editprivatepoll, name="editprivatepoll"),
